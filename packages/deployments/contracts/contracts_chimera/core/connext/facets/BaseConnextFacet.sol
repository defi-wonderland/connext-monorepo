...
import {TransferData, AppStorage} from "../libraries/LibConnextStorage.sol";
...
contract BaseConnextFacet {
  ...
  /**
   * @notice Calculates a transferHash
   */
  function _calculateTransferHash(TransferData memory _params) internal pure returns (bytes32) {
