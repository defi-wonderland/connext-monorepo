...
import { ConnextInterface as TConnextInterface } from "../../artifacts/typechain-types/hardhat-diamond-abi/HardhatDiamondABI.sol/Connext";
import { AdminSpokeConnectorInterface as TAdminSpokeConnectorInterface } from "../../artifacts/typechain-types/contracts/solidity/messaging/connectors/admin/AdminSpokeConnector";
import { AdminHubConnectorInterface as TAdminHubConnectorInterface } from "../../artifacts/typechain-types/contracts/solidity/messaging/connectors/admin/AdminHubConnector";
import { RootManagerInterface as TRootManagerInterface } from "../../artifacts/typechain-types/contracts/solidity/messaging/RootManager";
