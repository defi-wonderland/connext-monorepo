...
library ChainIDs {
  ...
  uint32 public constant GNOSIS_CHIADO = 10_200;
  uint32 public constant ARBITRUM_ONE = 42_161;
  uint32 public constant LINEA_TEST = 59_140;
  uint32 public constant LINEA = 59_144;
  uint32 public constant MUMBAI = 80_001;
  uint32 public constant ARBITRUM_GOERLI = 421_613;
}
