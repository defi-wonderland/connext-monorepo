...
contract AddressManager is OwnableUpgradeable, IAddressManager {
  ...
  event AddressSet(uint256 indexed domain, bytes32 indexed name, address newAddress, address oldAddress);
  ...
  function setAddress(uint256 domain, bytes32 name, address newAddress) external virtual onlyOwner {
