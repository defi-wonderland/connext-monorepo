...
import {BlockHeader, LibBlockHeader} from "./LibBlockHeader.sol";
import {ICrossChainSync} from "./ICrossChainSync.sol";
...
library LibBridgeStatus {
  ...
  function isMessageFailed(
    ...
    bytes32 syncedHeaderHash = ICrossChainSync(resolver.resolve("taiko", false)).getCrossChainBlockHash(
      uint64(sp.header.height)
    );
    ...
    return
      LibTrieProof.verifyWithFullMerkleProof({
